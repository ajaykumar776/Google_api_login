...
<body>
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-md-4 card-body" style="background-color: rgba(0,0,0,.03);height=400px; width=300px; ">
                <div class="panel panel-default">
                    <?php
                        if($login_button == ''){
                            ...
                            echo '<h5><a href="logout.php" class="btn btn-success">Logout</a></h5></div>';
                        }
                        else{
